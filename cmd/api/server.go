...
import (
	...
	"task-order/app/admin/models"
	"task-order/app/admin/router"
	"task-order/app/jobs"
	"task-order/common/database"
	"task-order/common/global"
	common "task-order/common/middleware"
	"task-order/common/middleware/handler"
	"task-order/common/storage"
	ext "task-order/config"
)
...
var (
	...
	StartCmd  = &cobra.Command{
		...
		Example:      "task-order server -c config/settings.yml",
		SilenceUsage: true,
