...
import (
	...
	"task-order/cmd/migrate/migration"
	_ "task-order/cmd/migrate/migration/version"
	_ "task-order/cmd/migrate/migration/version-local"
	"task-order/common/database"
	"task-order/common/models"
)
...
var (
	...
	StartCmd  = &cobra.Command{
		...
		Example: "task-order migrate -c config/settings.yml",
